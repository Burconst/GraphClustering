...
namespace GraphClustering.UnitTests
{
    ...
    public class CommunityManager
    {
        ...
        {
            Assert.AreEqual(0, getEdgeCount(_graphDict["DGraph1"],vertexFrom: 0, verticesTo: new int?[]{ 1,3,4,5,7 }), "Test 1");
            Assert.AreEqual(2, getEdgeCount(_graphDict["DGraph1"],vertexFrom: 10,verticesTo: new int?[]{ 2,4,11,6 }),  "Test 2");
            Assert.AreEqual(0, getEdgeCount(_graphDict["DGraph1"],vertexFrom: 0, verticesTo: new int?[]{ 0,1,5,7 }),   "Test 3");
            Assert.AreEqual(2, getEdgeCount(_graphDict["DGraph1"],vertexFrom: 5, verticesTo: new int?[]{ 0,1,5,7 }),   "Test 4");

            Assert.AreEqual(2, getEdgeCount(_graphDict["UGraph1"],vertexFrom: 0,verticesTo: new int?[]{ 1,2,4,6 }), "Test 5");
            Assert.AreEqual(1, getEdgeCount(_graphDict["UGraph1"],vertexFrom: 0,verticesTo: new int?[]{ 2,4,11,6 }), "Test 6");
        ...
        {
            Assert.AreEqual(3, getEdgeCount(_graphDict["DGraph1"],verticesFrom: new int?[]{ 1,3,4,5,7 },vertexTo: 0));
            Assert.AreEqual(0, getEdgeCount(_graphDict["DGraph1"],verticesFrom: new int?[]{ 2,4,11,6 },vertexTo: 10));
            Assert.AreEqual(3, getEdgeCount(_graphDict["DGraph1"],verticesFrom: new int?[]{ 0,1,5,7 },vertexTo: 0));
            Assert.AreEqual(1, getEdgeCount(_graphDict["DGraph1"],verticesFrom: new int?[]{ 0,1,5,7 },vertexTo: 5));

            Assert.AreEqual(2, getEdgeCount(_graphDict["UGraph1"],verticesFrom: new int?[]{ 1,2,4,6 },vertexTo: 0));
            Assert.AreEqual(4, getEdgeCount(_graphDict["UGraph1"],verticesFrom: new int?[]{ 0,1,2,4,8 },vertexTo: 0));
        ...
        {
            Assert.AreEqual(0, getEdgeCount(_graphDict["DGraph1"],verticesFrom: new int?[]{ 0,1,3,4,5,7 },verticesTo: new int?[]{ 2,6,8,9,10,11 }));
            Assert.AreEqual(0, getEdgeCount(_graphDict["DGraph1"],verticesFrom: new int?[]{ 5,1,0 },verticesTo: new int?[]{ 7,3,4 }));
            Assert.AreEqual(2, getEdgeCount(_graphDict["DGraph1"],verticesFrom: new int?[]{ 7,3,4 },verticesTo: new int?[]{ 5,1,0 }));

            Assert.AreEqual(2, getEdgeCount(_graphDict["UGraph1"],verticesFrom: new int?[]{ 0,4,8 },verticesTo: new int?[]{ 1,2,3 }));
            Assert.AreEqual(5, getEdgeCount(_graphDict["UGraph1"],verticesFrom: new int?[]{ 0,4,8 },verticesTo: new int?[]{ 0,1,2,3 }));
